 ...
 *
 */
public class BeginTransferringDICOMInstancesValidator implements ActiveParticipantValidatorMethod,
  ...
  private void checkActiveParticipant(final List<ActiveParticipant> activeParticipant)
    ...
    for (final ActiveParticipant activeParticipant2 : activeParticipant) {
      handleActiveParticipant(check, activeParticipant2);
    }
  ...
  private void handleActiveParticipant(final CountOfObjects check,
      final ActiveParticipant activeParticipant2) throws ValidatorException {
    if (handleDCM110153ActiveParticipant(check, activeParticipant2)
        && handleDCM110152ActiveParticipant(check, activeParticipant2)
        && checkUserRequesterOnlyOneTrue(check, activeParticipant2)
