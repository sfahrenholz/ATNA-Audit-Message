 ...
 *
 */
public class PatientDemographicsQueryTest {
	...
	public void testPatientDemographicsConsumerAuditMessage() throws Exception {
		...
		query.setParticipantObjectIDTypeCode(EventID.ITI_21);
		query.setParticipantObjectTypeCodeRole(ParticipantObjectTypeCodeRole.QUERY.getActionCode());
		query.setParticipantObjectID("patientsID");
		query.setParticipantObjectQuery("participantObjectQuery");
		query.setParticipantObjectDetail("participantObjectDetail");

		final AuditMessage messageStart = new PatientDemographicsQuery();
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messagePatientDemographicSource.xml"));
	...
	public void testPatientDemographicsSourceAuditMessage() throws Exception {
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messagePatientDemographicConsumer.xml"));
		assertEquals(content, convertXMLToString);
	}
