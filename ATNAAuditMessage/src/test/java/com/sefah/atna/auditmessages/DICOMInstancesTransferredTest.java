 ...
 *
 */
public class DICOMInstancesTransferredTest {

	private static Validator validator;

	@BeforeClass
	public static void beforeAll() throws ValidatorException {
		validator = ValidatorFactory.getInstance(EventID.DCM_110104);
	}
	...
	public void testDICOMInstancesAccessedCreate() throws Exception {
		...
		final AuditMessage messageStart = new DICOMInstancesTransferred();
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesTransferredCreate.xml"));
	...
	public void testDICOMInstancesAccessedUpdate() throws Exception {
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesTransferredUpdate.xml"));
		assertEquals(content, convertXMLToString);
	}
	...
	public void testDICOMInstancesAccessedRead() throws Exception {
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesTransferredRead.xml"));
		assertEquals(content, convertXMLToString);
	}
