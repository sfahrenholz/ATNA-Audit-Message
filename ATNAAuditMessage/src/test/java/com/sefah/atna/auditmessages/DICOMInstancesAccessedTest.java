 ...
 *
 */
public class DICOMInstancesAccessedTest {
	private static Validator validator;

	@BeforeClass
	public static void beforeAll() throws ValidatorException {
		validator = ValidatorFactory.getInstance(EventID.DCM_110103);
	}
	...
	public void testDICOMInstancesAccessedCreate() throws Exception {
		...
		final AuditMessage messageStart = new DICOMInstancesAccessed();
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesAccessedCreate.xml"));
		assertEquals(content, convertXMLToString);
	}

	@Test
	public void testDICOMInstancesAccessedUpdate() throws Exception {
		...
		final AuditMessage messageStart = new DICOMInstancesAccessed();
		messageStart.getEvent().setEventActionCode(EventActionCodes.UPDATE);
		messageStart.addActiveParticipant(person);
		messageStart.addActiveParticipant(processed);
		messageStart.addParticipantObjectIdentification(study);
		messageStart.addParticipantObjectIdentification(patient);
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesAccessedUpdate.xml"));
		assertEquals(content, convertXMLToString);
	}

	@Test
	public void testDICOMInstancesAccessedRead() throws Exception {
		...
		final AuditMessage messageStart = new DICOMInstancesAccessed();
		messageStart.getEvent().setEventActionCode(EventActionCodes.READ);
		messageStart.addActiveParticipant(person);
		messageStart.addActiveParticipant(processed);
		messageStart.addParticipantObjectIdentification(study);
		messageStart.addParticipantObjectIdentification(patient);
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesAccessedRead.xml"));
		assertEquals(content, convertXMLToString);
	}

	@Test
	public void testDICOMInstancesAccessedDelete() throws Exception {
		...
		final AuditMessage messageStart = new DICOMInstancesAccessed();
		messageStart.getEvent().setEventActionCode(EventActionCodes.DELETE);
		messageStart.addActiveParticipant(person);
		messageStart.addActiveParticipant(processed);
		messageStart.addParticipantObjectIdentification(study);
		messageStart.addParticipantObjectIdentification(patient);
		...
		final String content = new String(FileAccess.getBytesOfPackageMessage(
				"/com/sefah/atna/auditmessages/ressource/messageDICOMInstancesAccessedDelete.xml"));
		assertEquals(content, convertXMLToString);
	}
