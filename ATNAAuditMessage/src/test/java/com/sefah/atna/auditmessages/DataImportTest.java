...
public class DataImportTest {
	...
	public void testAuditMessageDataExport() throws Exception {
		...
		media.setRoleIDCode(EventID.DCM_110155);
		...
		// source.setUserIsRequestor(Boolean.FALSE);
		...
		final AuditMessage messageStart = new DataImport();
		...
		final String content = new String(FileAccess
				.getBytesOfPackageMessage("/com/sefah/atna/auditmessages/ressource/messageAuditMessageDataImport.xml"));
